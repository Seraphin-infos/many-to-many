...
<div class="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <!-- Arrière-plan décoratif (pour rappeler le style de ta landing page) -->
    ...
    <div class="max-w-xl w-full bg-white border border-slate-200/80 p-8 sm:p-10 rounded-3xl shadow-xl shadow-emerald-500/5 relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">
                Créer un <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-600">Nouveau Produit</span>
            </h1>
        ...
        @if(session('success'))
        <div class="mb-6 p-4 bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-semibold rounded-2xl flex items-center gap-2 shadow-sm animate-fade-in">
        ...
        <form action="{{ route('products.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-1.5">
                <label for="name" class="block text-xs font-bold text-slate-700 uppercase tracking-wider">Nom du produit</label>
                <div class="relative">
                    <input type="text" id="name" name="name" required
                        ...
                        placeholder="Ex: Application Dashboard">
                </div>
            </div>

            <!-- Grille à 2 colonnes pour Prix et Stock -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Champ : Prix -->
                <div class="space-y-1.5">
                    <label for="price" class="block text-xs font-bold text-slate-700 uppercase tracking-wider">Prix (€)</label>
                ...
                <!-- Champ : Stock -->
                <div class="space-y-1.5">
                    <label for="stock" class="block text-xs font-bold text-slate-700 uppercase tracking-wider">Stock Initial</label>
            ...
            <div class="space-y-1.5">
                ...
                <textarea id="description" name="description" rows="4"
                    ...
                    placeholder="Décrivez brièvement les spécifications du produit..."></textarea>
            </div>
